...
ransoms_signature = ' AND (((txout_value BETWEEN 1.9e8 AND 2.1e8) AND time > 1383523201) OR ((txout_value BETWEEN 0.4e8 AND 0.6e8) AND time BETWEEN 1384041600 AND 1385251199) OR ((txout_value BETWEEN 0.25e8 AND 0.35e8) AND time > 1385251200) OR ((txout_value BETWEEN 9.9e8 AND 10.1e8) AND time BETWEEN 1383264000 AND 1383523200)) AND time > 1378425600'
